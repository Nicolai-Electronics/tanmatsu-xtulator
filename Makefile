...
.PHONY: install
install:
	cd badgelink/tools; ./badgelink.sh appfs upload xtulator "xtulator PC emulator" 0 ../../build/tanmatsu/xtulator.bin

.PHONY: run
run:
	cd badgelink/tools; ./badgelink.sh start xtulator
