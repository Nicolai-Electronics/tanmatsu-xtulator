...
const MACHINEDEF_t machine_defs[] = {
    {"generic_xt", "Generic XT clone with VGA, speed unlimited", machine_init_generic_xt, VIDEO_CARD_VGA, -1,
     MACHINE_HW_BLASTER | MACHINE_HW_UART1_MOUSE | MACHINE_HW_DISK_HLE | MACHINE_HW_RTC},
...
const MACHINEMEM_t machine_mem[][10] = {
...
#ifndef USE_DISK_HLE
     {MACHINE_MEM_ROM, 0xD0000, 0x02000, MACHINE_ROM_REQUIRED, "/sd/xtulator/disk/ide_xt.bin"},
#endif
     {MACHINE_MEM_ROM, 0xFE000, 0x02000, MACHINE_ROM_REQUIRED, "/sd/xtulator/machine/generic_xt/pcxtbios.bin"},
    ...
    {{MACHINE_MEM_RAM, 0x00000, 0xA0000, MACHINE_ROM_ISNOTROM, NULL},
     ...
     {MACHINE_MEM_ROM, 0xD0000, 0x02000, MACHINE_ROM_REQUIRED, "/sd/xtulator/disk/ide_xt.bin"},
#endif
     {MACHINE_MEM_ROM, 0xF0000, 0x08000, MACHINE_ROM_REQUIRED, "/sd/xtulator/machine/ibm_xt/5000027.u19"},
     {MACHINE_MEM_ROM, 0xF8000, 0x08000, MACHINE_ROM_REQUIRED, "/sd/xtulator/machine/ibm_xt/1501512.u18"},
     {MACHINE_MEM_ENDLIST, 0, 0, 0, NULL}},
    ...
    {{MACHINE_MEM_RAM, 0x00000, 0xA0000, MACHINE_ROM_ISNOTROM, NULL},
     ...
     {MACHINE_MEM_ROM, 0xD0000, 0x02000, MACHINE_ROM_REQUIRED, "/sd/xtulator/disk/ide_xt.bin"},
#endif
     {MACHINE_MEM_ROM, 0xFE000, 0x02000, MACHINE_ROM_REQUIRED, "/sd/xtulator/machine/ami_xt/ami_8088_bios_31jan89.bin"},
     {MACHINE_MEM_ENDLIST, 0, 0, 0, NULL}},
    ...
    {{MACHINE_MEM_RAM, 0x00000, 0xA0000, MACHINE_ROM_ISNOTROM, NULL},
     ...
     {MACHINE_MEM_ROM, 0xD0000, 0x02000, MACHINE_ROM_REQUIRED, "/sd/xtulator/disk/ide_xt.bin"},
#endif
     {MACHINE_MEM_ROM, 0xFE000, 0x02000, MACHINE_ROM_REQUIRED, "/sd/xtulator/machine/phoenix_xt/000p001.bin"},
     {MACHINE_MEM_ENDLIST, 0, 0, 0, NULL}},
    ...
    {{MACHINE_MEM_RAM, 0x00000, 0xA0000, MACHINE_ROM_ISNOTROM, NULL},
     ...
     {MACHINE_MEM_ROM, 0xD0000, 0x02000, MACHINE_ROM_REQUIRED, "/sd/xtulator/disk/ide_xt.bin"},
#endif
     {MACHINE_MEM_ROM, 0xF0000, 0x10000, MACHINE_ROM_REQUIRED,
      "/sd/xtulator/machine/xi8088/bios128k-2.0.bin"},  // last half of this ROM is just filler for the 128k chip...
     {MACHINE_MEM_ENDLIST, 0, 0, 0, NULL}},
    ...
    {{MACHINE_MEM_RAM, 0x00000, 0xA0000, MACHINE_ROM_ISNOTROM, NULL},
     ...
     {MACHINE_MEM_ROM, 0xF8000, 0x08000, MACHINE_ROM_REQUIRED, "/sd/xtulator/machine/zenithss/z184m v3.1d.10d"},
     {MACHINE_MEM_ENDLIST, 0, 0, 0, NULL}},

    // Supersoft/Landmark diagnostic
    {{MACHINE_MEM_RAM, 0x00000, 0xA0000, MACHINE_ROM_ISNOTROM, NULL},
     {MACHINE_MEM_ROM, 0xF8000, 0x08000, MACHINE_ROM_REQUIRED, "/sd/xtulator/machine/landmark/landmark.bin"},
     {MACHINE_MEM_ENDLIST, 0, 0, 0, NULL}},
};
...
int machine_init_generic_xt(MACHINE_t* machine) {
    ...
    if ((machine->hwflags & MACHINE_HW_BLASTER) && !(machine->hwflags & MACHINE_HW_SKIP_BLASTER)) {
        ...
        machine->mixOPL     = 1;
    } else if ((machine->hwflags & MACHINE_HW_OPL) &&
               !(machine->hwflags & MACHINE_HW_SKIP_OPL)) {  // else if because some games won't detect an SB without
                                                             // seeing the OPL, so if SB enabled then OPL already is
...
int machine_init(MACHINE_t* machine, char* id) {
    ...
    while (1) {
        ...
        if ((temp == NULL) && ((machine_mem[num][i].required == MACHINE_ROM_REQUIRED) ||
                               (machine_mem[num][i].required == MACHINE_ROM_ISNOTROM))) {
